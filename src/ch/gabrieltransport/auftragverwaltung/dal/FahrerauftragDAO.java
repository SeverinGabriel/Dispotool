...
public class FahrerauftragDAO extends JPADAO<Fahrerauftrag, Integer> {
	 ...
	 */
	public List<Fahrerauftrag> findAllByEmployee(Fahrer employee) {
		EntityManager entityManager = em();
	
		CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
	
		ParameterExpression<Fahrer> employeeParameter = criteriaBuilder.parameter(Fahrer.class, "employee");
	
		CriteriaQuery<Fahrerauftrag> criteriaQuery = criteriaBuilder.createQuery(Fahrerauftrag.class);
	
		Root<Fahrerauftrag> root_fa = criteriaQuery.from(Fahrerauftrag.class);
		root_fa.alias("fa");
	
		criteriaQuery.where(criteriaBuilder.equal(root_fa.get(Fahrerauftrag_.fahrer), employeeParameter));
	
		TypedQuery<Fahrerauftrag> query = entityManager.createQuery(criteriaQuery);

...
public class LoginAuthView extends XdevView implements com.xdev.security.authentication.ui.LoginView {
	...
	private void cmdLogin_buttonClick(Button.ClickEvent event) {
		try {
			...
			GabrielAuthenticatorProvider authenticatorProvider = GabrielAuthenticatorProvider.getInstance();
			Object authenticationResult = authenticatorProvider.provideAuthenticator().authenticate(credentials);
			GabrielAuthorizationProvider authorizationConfigurationProvider = GabrielAuthorizationProvider
					.getInstance();
			...
			Authentication.login(authorizationManager.subject(credentials.username()), authenticationResult);
